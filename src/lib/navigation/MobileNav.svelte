...
<nav>
    <div class="inner">
        ...
        <ul class={`navbar-list${sidenav ? ' mobile' : ''}`}>
            <li>
                <a class="flex justify-center hover:text-gray-700 hover:no-underline center" data-mdb-ripple="true" data-mdb-ripple-color="dark" href='/'>Home</a>
            </li>
            <li>
                <a class="flex justify-center hover:text-gray-700 hover:no-underline" data-mdb-ripple="true" data-mdb-ripple-color="dark" href='/'>About</a>
            </li>
            <li>
